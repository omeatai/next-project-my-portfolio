...
export default function Form() {
  ...
  return (
    <form
      ...
      ref={formRef}
      className="flex flex-col items-center text-sm mb-5 gap-3"
    ...
    >
      ...
      <button
        type="submit"
        disabled={pending}
        className="flex items-center justify-center mt-1 font-medium h-7 bg-red-500/30 text-neutral-900 dark:text-neutral-100 rounded w-32"
      >
        Send
      </button>
    </form>
